                ...
                <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-6">
                    <div className="text-center lg:text-left">
                        <div className="flex flex-col md:flex-row items-center md:items-start gap-4 mb-2">
                            ...
                            <div>
                                <h1 className="text-3xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 uppercase">
                                    WEAPONS ARSENAL
                                </h1>
                                <p className="text-[10px] text-cyan-600 tracking-[0.3em] uppercase">STARK INDUSTRIES DEFENSE SYSTEMS</p>
                            </div>
                        </div>
                    </div>

                    {/* Arsenal Status */}
                    <div className="w-full max-w-sm bg-black/60 border-2 border-cyan-500 rounded-xl p-4 backdrop-blur-md shrink-0">
